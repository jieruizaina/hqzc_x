...
const state = reactive({
	...
	//文章formId
	wcformId: '78aaec41-7077-49f6-ae2d-647fd22d1369,8f0c3a76-d2ae-42f6-b863-d831017f51ae',
	//贷款栏目Id
...
const { articles, isRight, titleList, wcformId, total, pageCount, zcColumns, activeIndex, columnName, columnList } = toRefs(state)
//同栏目切换
